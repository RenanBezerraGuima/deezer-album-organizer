  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-[500px] border-4 border-primary brutalist-shadow">
        <DialogHeader>
          <DialogTitle className="text-2xl font-semibold uppercase tracking-tighter">Welcome to AlbumShelf</DialogTitle>
        ...
        <div className="py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            >
              ...
              <span className="font-medium uppercase text-xs">Deezer</span>
            </Button>
            <Button
            ...
            >
              ...
              <span className="font-medium uppercase text-xs text-center">Apple Music</span>
            </Button>
            <Button
            ...
            >
              ...
              <span className="font-medium uppercase text-xs">Spotify</span>
            </Button>
          </div>
        </div>
